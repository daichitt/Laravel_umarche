                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div>
                                        <input type="radio" id="selling" name="is_selling" value="1" class="mr-2" @if($shop->is_selling === 1){ checked } @endif>
                                        <label for="selling">販売中</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="not_selling" name="is_selling" value="0" class="mr-2" @if($shop->is_selling === 0){ checked } @endif>
