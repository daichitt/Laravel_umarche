                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div>
                                        <input type="radio" id="" name="type" value="{{\Constant::PRODUCT_LIST['add']}}" class="mr-2" checked>
                                        <label for="">追加</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="" name="type" value="{{\Constant::PRODUCT_LIST['reduce']}}" class="mr-2" >
                                        <label for="">削減</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="number" id="quantity" name="quantity" required value="0" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    <span class="text-su">0~99の範囲で入力して下さい</span>
                                </div>
                            </div>
                            ...
                            <x-select-image :images="$images" currentId="{{$product->image1}}" currentImage="{{$product->imageSecound->filename ?? ''}}" name="image2" />
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div>
                                        <input type="radio" id="selling" name="is_selling" value="1" class="mr-2" @if($product->is_selling === 1){ checked } @endif>
                                        <label for="selling">販売中</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="not_selling" name="is_selling" value="0" class="mr-2" @if($product->is_selling === 0){ checked } @endif>
                                        <label for="not_selling">販売停止中</label>
                                    </div>
                                </div>
                            </div>
